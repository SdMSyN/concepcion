  ...
  <!-- Cambio dinamico -->
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 buttonProduct"></div>
            <div class="col-sm-12 text-center" id="stockName"></div>
                ...
                <form id="formAddProductStock" name="formAddProductStock" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="inputProduct" id="inputProduct" class="">
                                <?= $optProducts; ?>
                            </select>
                        </div>  
                        <input type="text" name="inputCampo" id="inputCampo">
                    </div>
