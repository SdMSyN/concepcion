  ...
  <div class="row">
    <div class="col-md-4 sales sales-izquierda">
            ...
            <table id="dataTicket" class="table table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td colspan="2" >
                    <input class="form-control" type="text" id="inputTotal" name="inputTotal" readonly step=0.01 >
                  </td>
                  <td >
        ...
        <div class="teclado text-center">
          <form id="formTeclado" class="form-inline">
            <div class="form-group">
              <input class="form-control" type="text" id="inputCod" name="inputCod">
            </div>
    ...
    <div class="col-md-8 sales sales-derecha text-center">
      ...
      <div class="row productSubCategory"></div>
      <div class="row productInfo"></div>
    </div><!--  fin DERECHA-->
  </div>
