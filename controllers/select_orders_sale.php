<?php
    ...
    if($_GET['action'] == 'listar'){
        ...
        $sqlGetOrders = "SELECT id, nombre_cliente, fecha, fecha_entrega, total, (SELECT SUM(pago) FROM $tOrderPay WHERE pedido_info_id=$tOrderInfo.id ) as pago, (SELECT nombre FROM $tOrderEst WHERE id=$tOrderInfo.est_pedido_id) as est FROM $tOrderInfo WHERE est_pedido_id='1' ";
