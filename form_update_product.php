...
if (!isset($_SESSION['sessA']))
  ...
  if($rowGetProduct['pan_frio'] == '0')
      $optPanFrio.='<input type="checkbox" id="inputPanFrio" name="inputPanFrio" class="form-control" >';
  else
      $optPanFrio.='<input type="checkbox" id="inputPanFrio" name="inputPanFrio" class="form-control" checked>';
  ?>

  <!-- Cambio dinamico -->
  <div class="container">
    <div class="row">
      <form id="formUpdProduct" name="formUpdProduct" method="POST" >
